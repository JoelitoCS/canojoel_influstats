// Logos SVG oficiales de cada red social.
// Se usan en ProfilesTable, Rankings, PlatformPage, etc.
// size: tamaño en px (por defecto 20)
...
// SVG logos con las formas oficiales de cada plataforma
const LOGOS = {
  instagram: ({ size }) => (
